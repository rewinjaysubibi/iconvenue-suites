...
<div class="bg-white rounded-lg shadow-md">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-2xl font-bold text-gray-800">Create New Add-on</h2>
        <p class="text-gray-600 mt-1">Add a new service or item that clients can add to their venue bookings</p>
    </div>
    
    <form action="{{ route('admin.addons.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              ...
                              placeholder="Detailed description of the add-on service...">{{ old('description') }}</textarea>
                    @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <div id="stock-fields" class="space-y-4" style="display: none;">
                    <div>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3"
                              ...
                              placeholder="Internal notes about this add-on...">{{ old('notes') }}</textarea>
                    @error('notes')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i>Create Add-on
            </button>
        </div>
    </form>
</div>
